...
const mapDispatchToProps = (dispatch) => {
  return {
    onIngredientAdded: (ingredientName) => dispatch(actions.addIncrement(ingredientName)),
    onIngredientRemoved: (ingredientName) => dispatch(actions.removeIncrement(ingredientName)),
